...
@test "sign output with debug level 3" {
	...
	[ "$status" -eq 0 ]
	[[ "$output" =~ (Block no.   4: processing block header... ok.).(Block no.   4: .r.r..r..).(Block no.   4: processing partial signature data... ok.).(Block no.   4: writing block signature to file... ok.).(Block no.   4: Warning: all final tree hashes are missing.).(Block no.   5: processing block header... ok.).(Block no.   5: .r.r..r..).(Block no.   5: processing partial signature data... ok.).(Block no.   5: creating missing KSI signature... ok.*ms.).(Block no.   5: writing block signature to file... ok.).(Block no.   5: Warning: all final tree hashes are missing.) ]]
}